  ...
  return (
    <section className="text-center py-20 bg-gradient-to-r from-blue-600 via-purple-500 to-pink-600 rounded-b-xl shadow-lg px-4">
      ...
      <div className="mt-8 flex justify-center gap-4 flex-wrap">
        <SocialLink href="https://github.com/your-username" icon={<Github className="w-5 h-5 mr-2" />} label="GitHub" />
        <SocialLink href="https://linkedin.com/in/your-username" icon={<Linkedin className="w-5 h-5 mr-2" />} label="LinkedIn" />
        <SocialLink href="mailto:your@email.com" icon={<Mail className="w-5 h-5 mr-2" />} label="Email" />
      </div>
    </section>
  );
}
